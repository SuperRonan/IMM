...
// ViSP minor version.
#define VISP_VERSION_MINOR 1

// ViSP patch version.
#define VISP_VERSION_PATCH 0

// ViSP version with dots "3.1.0".
#define VISP_VERSION 3.1.0
...
#  define VISP_HAVE_OPENCV_VERSION 
#endif
...
#define VISP_SCENES_DIR "/private/student/7/67/16007067/tp4_ESIR/third-party/visp-3.1.0-build/share/visp-3.1.0/data/wireframe-simulator"

// Defined the path to the robot's arms 3D model used by the robot simulators
#define VISP_ROBOT_ARMS_DIR "/private/student/7/67/16007067/tp4_ESIR/third-party/visp-3.1.0-build/share/visp-3.1.0/data/robot-simulator"

// Defined if Ogre3d is available.
/* #undef VISP_HAVE_OGRE */

// Defined if Ogre3d plugins.cfg is available.
/* #undef VISP_HAVE_OGRE_PLUGINS_PATH */

// Defined if Ogre3d resources.cfg is available.
/* #undef VISP_HAVE_OGRE_RESOURCES_PATH */
